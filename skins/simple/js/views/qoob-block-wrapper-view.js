...
var QoobBlockWrapperView = Backbone.View.extend({ // eslint-disable-line no-unused-vars
    ...
    render: function() {
        ...
        this.innerBlock.once('loaded', function() {
            var droppable = _.template(self.storage.getSkinTemplate('block-droppable-preview'))({ "blockId": self.model.id, "text": this.storage.__('text_droppable_zone', 'Drop here to creative a new block') });
